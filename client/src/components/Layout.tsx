...
import { LayoutDashboard, ListMusic, BookOpen, Timer, LineChart, CalendarDays, Settings as SettingsIcon, WifiOff } from "lucide-react";
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
          ...
          {!isOnline && (
            <span className="flex items-center gap-1.5 rounded-full border border-amber-600/50 bg-amber-950/40 px-3 py-1 text-xs text-amber-300">
              ...
              Offline — results will sync later
            </span>
          )}
        </div>
