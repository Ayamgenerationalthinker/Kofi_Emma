// Mastery is calculated, never self-declared. All three gates — accuracy,
// tempo, and consistency across consecutive clean attempts — must pass
// before an exercise can flip to MASTERED. This is a pure function so it is
// trivially unit-testable and identical whether it runs against
// LocalStorage or (previously) a server database.
