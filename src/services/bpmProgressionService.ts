// A safe, conservative BPM ladder. Accuracy always gates tempo — this
// function is the only place tempo recommendations are computed so the
// "never reward speed over accuracy" rule can't be bypassed.
...
/** Builds a short upward BPM ladder from a clean starting tempo. */
